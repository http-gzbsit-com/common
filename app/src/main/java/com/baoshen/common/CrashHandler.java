...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    //用于格式化日期,作为日志文件名的一部分
    private DateFormat formatter = new SimpleDateFormat("yyyy-MM-dd-HH-mm-ss_SSS");
...
//            public void run() {
//                Looper.prepare();
//                Utils.toast("App crash",mContext);
//                Looper.loop();
//            }
//        }.start();
        //收集设备参数信息
    ...
    public static File getCrashDir(Context context){
        File dir = new File(FileUtils.getAppDirectory(context,FileUtils.AppCachehDir),"crash");
        if (!dir.exists()) {
            dir.mkdirs();
        }
        return dir;
